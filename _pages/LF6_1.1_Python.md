...
ˋˋˋ Der Fehler ist leicht zu beheben:
...
ˋˋˋpython File "/storage/emulated/0/qpython/.lasttmp.py", line 5 print("FBS") ^ SyntaxError: invalid syntax 1|u0a76@sofia3gr:/ $ ˋˋˋ
...
ˋˋˋpython 1 2 FBS Traceback (most recent call last): File "/storage/emulated/0/qpython/.lasttmp.py", line 6, in <module> print(a+b) TypeError: unsupported operand type(s) for +: 'int' and 'str' 1|u0a76@sofia3gr:/ $ ˋˋˋ
