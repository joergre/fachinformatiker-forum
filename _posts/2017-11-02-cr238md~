...
Es ist möglich, mit Hilfe von Github kostenlos eine Internetseite zu hosten (siehe <https://pages.github.com/>). Ebrenso kann ein eigener Domän-Namen verwendet werden. Bei der Verwendung eines eigenen Namens kann allerdings kein SSL verwendet werden.
